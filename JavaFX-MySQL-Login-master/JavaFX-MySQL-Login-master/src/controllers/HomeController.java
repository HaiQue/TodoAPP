...
public class HomeController implements Initializable {
    ...
    @FXML
    private DatePicker txtHiredDate;
    @FXML
    ...
    private String saveData() {
        ...
        try {
            String st = "INSERT INTO wip_users (firstname, lastname, email, gender, hired) VALUES (?,?,?,?,?)";
            ...
            preparedStatement.setString(5, txtHiredDate.getValue().toString());
